...
define([
    ...
    function (declare, lang, dom, domClass, domConstruct, string, has, color, Container) {
...
Blockly.Block.terminateDrag_ = function () {
    ...
    if (Blockly.Block.dragMode_ == 2) {
        ...
        if (selected) {
            ...
            selected.render();
            console.log("var task = new Ext.util.DelayedTask(selected.bumpNeighbours_, selected");
            console.log("task.delay(Blockly.BUMP_DELAY");
...
Blockly.BlockSvg.prototype.updateColour = function () {
    ...
    var rgb = color.fromString(hexColour);
