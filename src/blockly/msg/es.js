...
Blockly.Msg.AUTH =
    "Por favor, autoriza esta aplicación para permitir que tu trabajo se guarde y para permitir que sea compartido por ti.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
    "Tiene la variable %1 que toma los valores desde el número de inicio hasta el número final, contando por el intervalo especificado, y hacer los bloques especificados.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
    "Mientras que un valor es verdadero, entonces hacer algunas declaraciones.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_END =
    "Inserta el elemento a la posición especificada en la lista. #1 es el último elemento.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_START =
    "Inserta el elemento a la posición especificada en la lista. #1 es el primer elemento.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM_START =
    "Establece el elemento a la posición especificada en una lista. #1 es el primer elemento.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
    "Devolver verdadero si la primera entrada es mayor o igual a la segunda entrada.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
    "Devolver verdadero si la primera entrada es menor que o igual a la segunda entrada.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
    "Devolver verdadero si la entrada es falsa. Devolver falso si la entrada es verdadera.";
...
Blockly.Msg.MATH_IS_TOOLTIP =
    "Comprobar si un número es par, impar, primo, entero, positivo, negativo, o si es divisible por un número determinado. Devuelve verdadero o falso.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
    "Devolver una fracción aleatoria entre 0,0 (ambos inclusive) y 1.0 (exclusivo).";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
    "Devuelve el índice de la primera/última aparición del primer texto en el segundo texto. Devuelve 0 si el texto no se encuentra.";
