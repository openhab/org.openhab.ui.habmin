define(["dojo/_base/array", "dojo/_base/declare", "dojo/query",
		"dojo/_base/connect", "dojo/_base/Color", "dojox/charting/widget/Legend",
        "dijit/form/CheckBox", "dojox/charting/action2d/Highlight",
		"dojox/lang/functional", "dojox/gfx/fx", "dojo/keys", "dojo/dom-construct",
		"dojo/dom-prop", "dojo/dom-class"],
	function(arrayUtil, declare, query, hub, Color, Legend, CheckBox,
			 Highlight, df, fx, keys, dom, domProp, domClass){
	...
	var SelectableLegend = declare("dojox.charting.widget.SelectableLegend", Legend, {
		...
		_addLabel: function(dyn, label){
			...
			var checkbox = new CheckBox({checked: true, style: "display:none;"});
		...
		_applyEvents: function(){
			...
			arrayUtil.forEach(this.legends, function(legend, i){
                ...
                //	toggle action
				var legendCheckBox = query(".dojoxLegendText", legend)[0];
				hub.connect(legendCheckBox, "onclick", this, function(e){
					var x = this._toggle(shapes, i, legend.vanished, originalDyn, seriesName, plotName);
					legend.vanished = !legend.vanished;
                    domClass.toggle(legendCheckBox, "habminLegendDisabled");
					e.stopPropagation();
				});
