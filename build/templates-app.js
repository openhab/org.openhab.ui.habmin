...
angular.module("binding/zwave.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("binding/zwave.tpl.html",
    ...
    "                    </li>\n" +
    "                </ul>\n" +
    "                <button ng-show=\"deviceDisplay=='CONFIG'\" type=\"button\" ng-class=\"{'btn btn-default':true, 'disabled':!isDirty}\">\n" +
    "                    <span class=\"fa fa-floppy-o\"></span>\n" +
    ...
    "                <binding-config template=\"{{devEdit.configuration}}\" binding-change=\"isDirty=true\">\n" +
    "                </binding-config>\n" +
    "            </div>\n" +
    "\n" +
    "            <!-- ASSOCIATIONS -->\n" +
    ...
    "                <binding-config template=\"{{devEdit.associations}}\">\n" +
    "                </binding-config>\n" +
    "            </div>\n" +
    "\n" +
    "            <!-- WAKEUP -->\n" +
